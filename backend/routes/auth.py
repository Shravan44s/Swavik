...
def register():
    try:
        ...
        return jsonify({'message': 'User registered successfully', 'token': generate_token(user_id), 'user': user}), 201

    except Exception as e:
        print("🔥 REGISTER ERROR:", str(e))       # ✅ <-- THIS WILL SHOW THE REAL PROBLEM
